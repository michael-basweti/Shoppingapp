...
public class Sna extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabaseCurrentUser=FirebaseDatabase.getInstance().getReference().child("Snacks");
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Blog15,BlogViewHolder> firebaseRecyclerAdapter=new FirebaseRecyclerAdapter<Blog15, BlogViewHolder>(
                Blog15.class,
                R.layout.blog_snack,
            ...
            @Override
            protected void populateViewHolder(BlogViewHolder viewHolder, Blog15 model, int position) {
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        Intent singleBlogIntent=new Intent(Sna.this,DetailSnack.class);
                ...
                viewHolder.mView.setOnLongClickListener(new View.OnLongClickListener() {
                    ...
                    public boolean onLongClick(View view) {
                        Intent singleBlogIntent=new Intent(Sna.this,Sna.class);
                        singleBlogIntent.putExtra("blog_id",post_key);
                        startActivity(singleBlogIntent);
                        return true;
