...
public class Cereal_Retrieval extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cereal__retrieval);
        mAuth=FirebaseAuth.getInstance();


        mDatabase= FirebaseDatabase.getInstance().getReference().child("Cereal");
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Blog5,BlogViewHolder> firebaseRecyclerAdapter=new FirebaseRecyclerAdapter<Blog5, BlogViewHolder>(
                Blog5.class,
                R.layout.blogrow_cereal,
                BlogViewHolder.class,
                mDatabase

        ) {
            @Override
            protected void populateViewHolder(BlogViewHolder viewHolder, Blog5 model, int position) {
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        Intent singleBlogIntent=new Intent(Cereal_Retrieval.this,Decer.class);
                ...
                viewHolder.mView.setOnLongClickListener(new View.OnLongClickListener() {
                    ...
                    public boolean onLongClick(View view) {
                        Intent singleBlogIntent=new Intent(Cereal_Retrieval.this,Cereal_Retrieval.class);
                        singleBlogIntent.putExtra("blog_id",post_key);
                        startActivity(singleBlogIntent);
                        return true;
