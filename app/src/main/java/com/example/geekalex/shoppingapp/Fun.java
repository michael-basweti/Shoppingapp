...
public class Fun extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabaseCurrentUser=FirebaseDatabase.getInstance().getReference().child("Furniture");
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Blog12,BlogViewHolder> firebaseRecyclerAdapter=new FirebaseRecyclerAdapter<Blog12, BlogViewHolder>(
                Blog12.class,
                R.layout.blog_fun,
            ...
            @Override
            protected void populateViewHolder(BlogViewHolder viewHolder, Blog12 model, int position) {
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        Intent singleBlogIntent=new Intent(Fun.this,DetailFurn.class);
                ...
                viewHolder.mView.setOnLongClickListener(new View.OnLongClickListener() {
                    ...
                    public boolean onLongClick(View view) {
                        Intent singleBlogIntent=new Intent(Fun.this,Fun.class);
                        singleBlogIntent.putExtra("blog_id",post_key);
                        startActivity(singleBlogIntent);
                        return true;
