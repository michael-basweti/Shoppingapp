...
public class Mac extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabaseCurrentUser=FirebaseDatabase.getInstance().getReference().child("Machinery");
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Blog10,BlogViewHolder> firebaseRecyclerAdapter=new FirebaseRecyclerAdapter<Blog10, BlogViewHolder>(
                Blog10.class,
                R.layout.blog_mac,
            ...
            @Override
            protected void populateViewHolder(BlogViewHolder viewHolder, Blog10 model, int position) {
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        Intent singleBlogIntent=new Intent(Mac.this,DetailMac.class);
                ...
                viewHolder.mView.setOnLongClickListener(new View.OnLongClickListener() {
                    ...
                    public boolean onLongClick(View view) {
                        Intent singleBlogIntent=new Intent(Mac.this,Mac.class);
                        singleBlogIntent.putExtra("blog_id",post_key);
                        startActivity(singleBlogIntent);
                        return true;
