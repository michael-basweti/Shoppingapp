...
public class Bread_Retrieval extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bread__retrieval);
        mAuth=FirebaseAuth.getInstance();


        mDatabase= FirebaseDatabase.getInstance().getReference().child("Bread");
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Blog8,BlogViewHolder> firebaseRecyclerAdapter=new FirebaseRecyclerAdapter<Blog8, BlogViewHolder>(
                Blog8.class,
                R.layout.blogrow_bread,
                BlogViewHolder.class,
                mDatabase

        ) {
            @Override
            protected void populateViewHolder(BlogViewHolder viewHolder, Blog8 model, int position) {
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        Intent singleBlogIntent=new Intent(Bread_Retrieval.this,Debre.class);
                ...
                viewHolder.mView.setOnLongClickListener(new View.OnLongClickListener() {
                    ...
                    public boolean onLongClick(View view) {
                        Intent singleBlogIntent=new Intent(Bread_Retrieval.this,Bread_Retrieval.class);
                        singleBlogIntent.putExtra("blog_id",post_key);
                        startActivity(singleBlogIntent);
                        return true;
