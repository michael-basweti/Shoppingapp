...
public class Bread extends AppCompatActivity {
    ...
    private void postCommodities() {
        ...
        if (!TextUtils.isEmpty(name)&&!TextUtils.isEmpty(description)&&!TextUtils.isEmpty(price)&&mImageUri!=null
                            ...
                            newPost.child("name").setValue( dataSnapshot.child("name").getValue()).addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if (task.isSuccessful()) {
                                        ...
                                        Toast.makeText(Bread.this, "Please fill all the spaces or check your internet connection...", Toast.LENGTH_LONG).show();
            ...
            mProgress.dismiss();
            Toast.makeText(Bread.this, "Your Data Has been sent", Toast.LENGTH_LONG).show();

            Intent mainIntent = new Intent(Bread.this, Bread.class);
