...
public class Bed extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Blog11,BlogViewHolder> firebaseRecyclerAdapter=new FirebaseRecyclerAdapter<Blog11, BlogViewHolder>(
                Blog11.class,
                R.layout.blog_bed,
            ...
            @Override
            protected void populateViewHolder(BlogViewHolder viewHolder, Blog11 model, int position) {
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        Intent singleBlogIntent=new Intent(Bed.this,DetailBed.class);
                ...
                viewHolder.mView.setOnLongClickListener(new View.OnLongClickListener() {
                    ...
                    public boolean onLongClick(View view) {
                        Intent singleBlogIntent=new Intent(Bed.this,Bed.class);
                        singleBlogIntent.putExtra("blog_id",post_key);
                        startActivity(singleBlogIntent);
                        return true;
