...
public class Mac_Retrieval extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mac__retrieval);
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Blog4,BlogViewHolder> firebaseRecyclerAdapter=new FirebaseRecyclerAdapter<Blog4, BlogViewHolder>(
                Blog4.class,
                R.layout.blogrow_mac,
                BlogViewHolder.class,
                mDatabase

        ) {
            @Override
            protected void populateViewHolder(BlogViewHolder viewHolder, Blog4 model, int position) {
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        Intent singleBlogIntent=new Intent(Mac_Retrieval.this,Demac.class);
                ...
                viewHolder.mView.setOnLongClickListener(new View.OnLongClickListener() {
                    ...
                    public boolean onLongClick(View view) {
                        Intent singleBlogIntent=new Intent(Mac_Retrieval.this,Mac_Retrieval.class);
                        singleBlogIntent.putExtra("blog_id",post_key);
                        startActivity(singleBlogIntent);
                        return true;
