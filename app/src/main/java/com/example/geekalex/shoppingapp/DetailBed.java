...
public class DetailBed extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_bed);
        ...
        mDatabase.child(mPost_key).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                Picasso.with(DetailBed.this).load(post_image).into(mBlogSingleImage);
        ...
        mSingleRemoveBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent mainIntent=new Intent(DetailBed.this,Bed.class);
