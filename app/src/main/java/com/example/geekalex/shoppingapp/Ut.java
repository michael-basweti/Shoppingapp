...
public class Ut extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabaseCurrentUser=FirebaseDatabase.getInstance().getReference().child("Utensils");
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Blog16,BlogViewHolder> firebaseRecyclerAdapter=new FirebaseRecyclerAdapter<Blog16, BlogViewHolder>(
                Blog16.class,
                R.layout.blog_ut,
            ...
            @Override
            protected void populateViewHolder(BlogViewHolder viewHolder, Blog16 model, int position) {
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        Intent singleBlogIntent=new Intent(Ut.this,DetailUtensil.class);
                ...
                viewHolder.mView.setOnLongClickListener(new View.OnLongClickListener() {
                    ...
                    public boolean onLongClick(View view) {
                        Intent singleBlogIntent=new Intent(Ut.this,Ut.class);
                        singleBlogIntent.putExtra("blog_id",post_key);
                        startActivity(singleBlogIntent);
                        return true;
