...
public class Cer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabaseCurrentUser=FirebaseDatabase.getInstance().getReference().child("Cereal");
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Blog13,BlogViewHolder> firebaseRecyclerAdapter=new FirebaseRecyclerAdapter<Blog13, BlogViewHolder>(
                Blog13.class,
                R.layout.blog_cer,
            ...
            @Override
            protected void populateViewHolder(BlogViewHolder viewHolder, Blog13 model, int position) {
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        Intent singleBlogIntent=new Intent(Cer.this,DetailCer.class);
                ...
                viewHolder.mView.setOnLongClickListener(new View.OnLongClickListener() {
                    ...
                    public boolean onLongClick(View view) {
                        Intent singleBlogIntent=new Intent(Cer.this,Cer.class);
                        singleBlogIntent.putExtra("blog_id",post_key);
                        startActivity(singleBlogIntent);
                        return true;
