...
public class Groc extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabaseCurrentUser=FirebaseDatabase.getInstance().getReference().child("Grocery");
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Blog17,BlogViewHolder> firebaseRecyclerAdapter=new FirebaseRecyclerAdapter<Blog17, BlogViewHolder>(
                Blog17.class,
                R.layout.blog_groc,
            ...
            @Override
            protected void populateViewHolder(BlogViewHolder viewHolder, Blog17 model, int position) {
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        Intent singleBlogIntent=new Intent(Groc.this,DetailGroc.class);
                ...
                viewHolder.mView.setOnLongClickListener(new View.OnLongClickListener() {
                    ...
                    public boolean onLongClick(View view) {
                        Intent singleBlogIntent=new Intent(Groc.this,Groc.class);
                        singleBlogIntent.putExtra("blog_id",post_key);
                        startActivity(singleBlogIntent);
                        return true;
