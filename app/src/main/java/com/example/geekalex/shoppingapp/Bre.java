...
public class Bre extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabaseCurrentUser=FirebaseDatabase.getInstance().getReference().child("Bread");
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Blog14,BlogViewHolder> firebaseRecyclerAdapter=new FirebaseRecyclerAdapter<Blog14, BlogViewHolder>(
                Blog14.class,
                R.layout.blog_bread,
            ...
            @Override
            protected void populateViewHolder(BlogViewHolder viewHolder, Blog14 model, int position) {
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        Intent singleBlogIntent=new Intent(Bre.this,DeatailBread.class);
                ...
                viewHolder.mView.setOnLongClickListener(new View.OnLongClickListener() {
                    ...
                    public boolean onLongClick(View view) {
                        Intent singleBlogIntent=new Intent(Bre.this,Bre.class);
                        singleBlogIntent.putExtra("blog_id",post_key);
                        startActivity(singleBlogIntent);
                        return true;
