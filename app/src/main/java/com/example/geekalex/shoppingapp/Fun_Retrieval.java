...
public class Fun_Retrieval extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fun__retrieval);
        mAuth=FirebaseAuth.getInstance();


        mDatabase= FirebaseDatabase.getInstance().getReference().child("Furniture");
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Blog2,BlogViewHolder> firebaseRecyclerAdapter=new FirebaseRecyclerAdapter<Blog2, BlogViewHolder>(
                Blog2.class,
                R.layout.blogrow_fun,
                BlogViewHolder.class,
                mDatabase

        ) {
            @Override
            protected void populateViewHolder(BlogViewHolder viewHolder, Blog2 model, int position) {
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        Intent singleBlogIntent=new Intent(Fun_Retrieval.this,Defun.class);
                ...
                viewHolder.mView.setOnLongClickListener(new View.OnLongClickListener() {
                    ...
                    public boolean onLongClick(View view) {
                        Intent singleBlogIntent=new Intent(Fun_Retrieval.this,Fun_Retrieval.class);
                        singleBlogIntent.putExtra("blog_id",post_key);
                        startActivity(singleBlogIntent);
                        return true;
