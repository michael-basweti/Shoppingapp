...
public class DetailFurn extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_furn);
        ...
        mDatabase.child(mPost_key).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                Picasso.with(DetailFurn.this).load(post_image).into(mBlogSingleImage);
        ...
        mSingleRemoveBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent mainIntent=new Intent(DetailFurn.this,Fun.class);
