...
public class Ut_Retrieval extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ut__retrieval);
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Blog3,BlogViewHolder> firebaseRecyclerAdapter=new FirebaseRecyclerAdapter<Blog3, BlogViewHolder>(
                Blog3.class,
                R.layout.blogrow_utens,
                BlogViewHolder.class,
                mDatabase

        ) {
            @Override
            protected void populateViewHolder(BlogViewHolder viewHolder, Blog3 model, int position) {
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        Intent singleBlogIntent=new Intent(Ut_Retrieval.this,Deut.class);
                ...
                viewHolder.mView.setOnLongClickListener(new View.OnLongClickListener() {
                    ...
                    public boolean onLongClick(View view) {
                        Intent singleBlogIntent=new Intent(Ut_Retrieval.this,Ut_Retrieval.class);
                        singleBlogIntent.putExtra("blog_id",post_key);
                        startActivity(singleBlogIntent);
                        return true;
